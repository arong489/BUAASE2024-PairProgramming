...
const fs = require('fs');
const wasmSource = new Uint8Array(fs.readFileSync("./t1-c/bocchiShutUp.wasm"));
...
export default function bocchiShutUp(flag, seq, len) {
    // transform
    ...
    const result = wasmInstance.exports.bocchiShutUp(flag, ptr, len);
